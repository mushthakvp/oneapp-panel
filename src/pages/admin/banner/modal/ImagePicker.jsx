...
function ImagePicker({ image, setImage,imageSet }) {
  ...
  return (
    <div className="flex items-center">
      <div
        className={`w-full border-2 border-dashed max-h-[193px] relative ${
          ...
          <>
            ...
            <div className="w-full text-center ">
              ...
              <p className="text-[#5D7186] text-[13px] mt-2">
                396W x 210H (PX) recommended. PNG, JPG
              </p>
            </div>
          </>
        )}
