        ...
        <>
            <div className="flex flex-col md:flex-row gap-4 font-urbanist mt-[31px]">
                {[1, 2, 3].map((_, index) => (
                    <div
                        key={index}
                        className="bg-containerWhite p-[18px] h-72 border border-inputBorder rounded-md animate-pulse w-full md:w-1/3"
                    >
            ...
            <div className="flex flex-col md:flex-row gap-4 font-urbanist mt-[31px]">
                {[1, 2].map((_, index) => (
                    <div
                        key={index}
                        className="bg-containerWhite p-[18px] border border-inputBorder rounded-md animate-pulse w-full md:w-1/3"
                    >
                        <div className="h-6 w-1/2 bg-gray-200 rounded mb-4"></div>
                        <div className="h-5 w-3/4 bg-gray-200 rounded mb-4"></div>
                        <div className="h-4 w-1/2 bg-gray-200 rounded mb-2"></div>
